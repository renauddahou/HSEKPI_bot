...
def start(update: Update, _: CallbackContext) -> None:
    ...
    update.message.reply_markdown_v2(
        f"Hi {user.mention_markdown_v2()}\!je suis HSEbot une intelligence artificielle qui t'aide à identifier les dangers et les risques ainsi qu'à les prévenirs.",
